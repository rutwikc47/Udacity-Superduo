...
public class AddBook extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        beforeload= (RelativeLayout) rootView.findViewById(R.id.rl_before_book_load);
        afterload=(RelativeLayout) rootView.findViewById(R.id.rl_after_book_load);

        beforeload.setVisibility(View.VISIBLE);
        afterload.setVisibility(View.INVISIBLE);
    ...
    public void onLoadFinished(android.support.v4.content.Loader<Cursor> loader, Cursor data) {
        if (!data.moveToFirst()) {
            ...
            if (bookTitle!=null){
                ...
                ((TextView) rootView.findViewById(R.id.bookTitle)).setText(R.string.no_info);
            }
            ...
            if (bookSubTitle!=null){
                ...
                ((TextView) rootView.findViewById(R.id.bookSubTitle)).setText(R.string.no_info);
            ...
            beforeload.setVisibility(View.INVISIBLE);
